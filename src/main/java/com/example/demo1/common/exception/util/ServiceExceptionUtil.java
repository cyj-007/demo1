package com.example.demo1.common.exception.util;

import com.example.demo1.common.exception.ErrorCode;
import com.example.demo1.common.exception.ServiceException;
 ...
 *
 * 1. 异常提示信息，写在枚举类中，例如说，soft.guide.tajicloud.user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
...
public class ServiceExceptionUtil {
     ...
     * @return
     */
    public static ServiceException exception(String errorMessage) {
        return exception0(123456789, errorMessage);
    }
